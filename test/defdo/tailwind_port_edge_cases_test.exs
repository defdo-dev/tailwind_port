  ...
  describe "edge cases and error paths" do
    ...
    test "command building edge cases" do
      ...
      test_cases = [
        ...
        ["-i", "input.css", "--input", "input2.css"],
        # Duplicate output options
        ["-o", "output.css", "--output", "output2.css"],
        # Duplicate watch options
        ["--watch", "-w"],
        # Duplicate poll options
        ["--poll", "-p"],
        # Duplicate minify options
        ["--minify", "-m"],
        # Duplicate config options
        ["--config", "config.js", "-c", "config2.js"],
        # No autoprefixer option
        ["--no-autoprefixer"],
